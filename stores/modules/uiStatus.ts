    ...
    const jump = (e: MouseEvent) => {
        if (listEle.value) {
            ...
            const startX = Math.round(
                startRect.left + (startRect.width / 4) * 3
            )
            ...
            ;(div.children[0] as HTMLElement).style.transform =
